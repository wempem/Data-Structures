...
#include "/mnt/c/Windows/System32/csci-315-fall-2017/project3/src/avl-tests.cpp"

static MyTestSuite1 suite_MyTestSuite1;

static CxxTest::List Tests_MyTestSuite1 = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MyTestSuite1( "src/avl-tests.cpp", 6, "MyTestSuite1", suite_MyTestSuite1, Tests_MyTestSuite1 );
