...
#include "/home/pwest/csu/courses/csci-315-fall-2017/lab19/test/lf-test.cpp"

static MyTestSuite1 suite_MyTestSuite1;

static CxxTest::List Tests_MyTestSuite1 = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MyTestSuite1( "test/lf-test.cpp", 6, "MyTestSuite1", suite_MyTestSuite1, Tests_MyTestSuite1 );
