...
\vskip.15in
\noindent\textbf{Instructions:} Implement a Stack and a Queue with whatever data structure you desire.  Remember you may use code from a previous lab (*hint* *hint*).
...
\vskip.15in
\noindent\textbf{Outside Resources:} \\
You may \textbf{not} use any outside resources.  (IE: No STL, Boost, etc...)
