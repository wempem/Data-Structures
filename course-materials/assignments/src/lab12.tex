...
\vskip.15in
\noindent\textbf{Part 1:} Implement Selection and Insertion sort for your Array List class.  Then implement any of the basic sorts (Bubble, Selection, or Insertion) for a singly Linked List. \textbf{Note:} Keep your old implementation and append the following functions:
