...
#include "/home/pwest/csu/courses/csci-315-fall-2017/class-code/grapham/tests/breadth-test.cpp"

static MyTestSuite1 suite_MyTestSuite1;

static CxxTest::List Tests_MyTestSuite1 = { 0, 0 };
CxxTest::StaticSuiteDescription suiteDescription_MyTestSuite1( "tests/breadth-test.cpp", 10, "MyTestSuite1", suite_MyTestSuite1, Tests_MyTestSuite1 );
